...
export default defineConfig({
  plugins: [
    ...
    VitePWA({
      ...
      workbox: { globPatterns: ["/index.html,**/*.{js,css,html,ico,png,svg,webp"] },
      manifest: {
        name: "Daily Tarot",
        short_name: "Tarot",
        start_url: ".",
        ...
        description:
          "An app that enables users to draw a single tarot card, providing both its meaning and keywords, while also offering a comprehensive index with interpretations for all tarot cards.",
        icons: [
          {
            src: "favicon.ico",
